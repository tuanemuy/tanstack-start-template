...
// app side: keeping it out of `app/core/application/di/d1.ts` prevents
// the AsyncLocalStorage import from leaking into the client bundle
// when server-fn dynamic imports are traced.
//
