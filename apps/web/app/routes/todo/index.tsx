...
export const Route = createFileRoute("/todo/")({
  ...
  // `Deferred` below resolves. With `staleTime: 0` the loader re-runs
  ...
  // by the explicit `useReconcile()` each mutation awaits, so cache the
  ...
  loader: async ({ deps }) => {
    ...
    // list streams in under `Deferred`'s fallback.
